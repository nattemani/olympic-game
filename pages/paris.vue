      ...
      >
        ...
        <v-col>
          ...
          >
            ...
            >
              <v-avatar size="290">
                <v-img :src="require(`~/assets/paris/chap1.jpg`)" />
              </v-avatar>
            </div>
            <div
              class="circle white__circle"
            ...
            >
              <v-avatar size="290">
                <v-img :src="require(`~/assets/paris/chap2.jpg`)" />
              </v-avatar>
            </div>
            <div
              class="circle white__circle"
            ...
            >
              <v-avatar size="290">
                <v-img :src="require(`~/assets/paris/chap3.jpg`)" />
              </v-avatar>
            </div>
          </v-col>
          <v-col
...
export default {
  ...
  computed: {
    ...
    activeChapterPositionText() {
      if (this.activeChapter === 'blue') {
        return 'top: 120px; right: 100px; font-size: 1.25em;'
      } else if (this.activeChapter === 'red') {
    ...
    activeChapterText() {
      if (this.activeChapter === 'blue') {
        ...
        Le budget a augmenté d’environ 10%. 
        Exemple :  Augmentation des moyens alloués à la sécurité et les transports notamment.
        `
      } else if (this.activeChapter === 'green') {
        return `
